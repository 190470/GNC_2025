Public NotInheritable Class SplashScreen1
    ...
    Private Sub SplashScreen1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Version.Text = "GNC Version 3.0 - 2023" 'System.String.Format(Version.Text, My.Application.Info.Version.Major, My.Application.Info.Version.Minor)

        'Informations de copyright
        Copyright.Text = "Copyright  MCS-CI 2022" '  My.Application.Info.Copyright
    End Sub
